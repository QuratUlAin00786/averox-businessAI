            ...
            <TabsContent value="register">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Register for a new AVEROX CRM account
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <Form {...registerForm}>
        ...
        <div className="flex flex-col justify-center items-center p-12 w-full">
          <div className="max-w-md text-center">
            ...
            <p className="text-blue-700 mb-8">
              AVEROX CRM brings intelligent lead management, advanced analytics, and seamless team collaboration to help your business grow.
            </p>
