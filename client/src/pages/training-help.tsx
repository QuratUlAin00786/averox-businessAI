            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col items-center text-center p-4 border border-neutral-200 rounded-md hover:border-primary hover:bg-primary/5 transition-colors">
                  ...
                  <SimpleButton variant="link" onClick={() => window.open('https://averox.com/tutorials/videos', '_blank')}>{t.buttons.watchNow} <ArrowRight className="ml-1 w-4 h-4" /></SimpleButton>
                </div>
